...
public class UserController {
    ...
    public String getpic(String username){
       ...
       if(username==null){
        ...
        if(userById!=null){
        String profilehead = userById.getProfilehead();
        return profilehead;}
        else
            msg="false";
        return msg;
    ...
    @ResponseBody
    public User head(@PathVariable("userid") String userid, HttpServletRequest request, HttpServletResponse response) throws Exception{


            String  userid1 = new String(userid.getBytes("ISO8859_1"),"UTF-8");
    ...
    public String updateUser(@PathVariable("userid") String userid, HttpSession session, User user, RedirectAttributes attributes, HttpServletRequest request) throws  Exception{
    ...
    @ResponseBody
    public String updateUserPassword(@PathVariable("userid") String userid,String image,HttpServletRequest request,HttpSession httpSession){

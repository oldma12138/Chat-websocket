...
public class ChatServer{
     ...
     */
    @OnOpen
    public void onOpen(@PathParam("userid") String userid1 , Session session, EndpointConfig config)throws Exception{
        String userid=new String(userid1.getBytes("ISO8859_1"),"UTF-8");
     ...
     */
    @OnClose
    public void onClose(@PathParam("userid") String userid1,Session session,CloseReason closeReason) throws Exception{
     ...
     */
    @OnMessage
    public void onMessage(@PathParam("userid") String userid1,String data) throws Exception{
        String userid=new String(userid1.getBytes("ISO8859_1"),"UTF-8");
     ...
     */
    @OnError
    public void onError(@PathParam("userid") String userid1,Session session,Throwable throwable) throws Exception{
        String userid=new String(userid1.getBytes("ISO8859_1"),"UTF-8");

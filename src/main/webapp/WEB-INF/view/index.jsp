    ...
    <div class="admin-content">
        <div class="" style="width: 80%;float:left;">
            ...
            <div class="am-btn-group am-btn-group-xs" style="float:right;">
                ...
                <button class="am-btn am-btn-default" type="button" onclick="clearConsole()"><span class="am-icon-qq"></span> 图片</button>
        ...
        <div class="am-panel am-panel-default" style="float:right;width: 20%;">
            ...
            <div class="am-panel-hd">
                <h3 class="am-panel-title">好友列表 [<span id="friend"></span>]</h3>
            </div>
...
<script>
    ...
    function showChat(message){
        ...
        $.getJSON(url,function(data){
            pic =  "${ctx}/static/source/pic/"+data.profilehead+"" ;
            console.log(data.profilehead)
    ...
    function showOnline(list){
        ...
        $.each(list, function(index, item){     //添加私聊按钮
            ...
            else if('${userid}' != item.userid){    //排除自己


                $.post("/findFriendbyname",{"username":item.nickname},function (data) {
                    var li = "";
                        console.log(data)
                    if (data!='0') {
                    ...
                    li = "<li>"+item.nickname+" <button type=\"button\" class=\"am-btn am-btn-xs am-btn-primary am-round\" onclick=\"addChat('"+username+"');\"><span class=\"am-icon-phone\"><span> 私聊</button></li>";
                       ...
                       var userid= item.userid
                        li = "<li>"+item.nickname+" <button type=\"button\" class=\"am-btn am-btn-xs am-btn-primary am-round\" onclick=\"addfriend('"+userid+"');\"><span class=\"am-icon-phone\"><span> 添加好友</button></li>";
                               $("#list").append(li)
                    }
 ...
 *
 */
  function addfriend(username2) {
      console.log(username2)
    $.post("/add",{"username":username2},function (data) {
        if (data=='1'){
            alert("添加成功，请等待回应");
        } else if (data=='2') {
            alert("您已添加好友请耐心等待");
